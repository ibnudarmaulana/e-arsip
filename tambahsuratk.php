...
<form action="" method="POST" enctype="multipart/form-data">
	...
	<input class="form-control date-picker col-md-3" name="tanggal_surat" placeholder="Pilih Tanggal Surat..." type="text">
	</div>
	<div class="form-group">
		<label>Nomor Surat</label>
		<input class="form-control" value="" type="text" name="nomor_surat" placeholder="Masukan Nomor Surat...">
	</div>
	<div class="form-group">
